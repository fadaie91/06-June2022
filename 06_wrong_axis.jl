...
ax_bp = Axis(fig[1, 2],limits = ((-4, 4), (-1, 0)), title=partial_cell_title)
ax_bf = Axis(fig[2, 2], limits = ((-4, 4), (-1, 0)),title="GridFittedBottom")
ax_bd = Axis(fig[3, 2], limits = ((-4, 4), (-1, 0)),title="Difference (GridFitted - PartialCell)")

ax_vp = Axis(fig[1, 4], limits = ((-4, 4), (-1, 0)),title=partial_cell_title)
ax_vf = Axis(fig[2, 4], limits = ((-4, 4), (-1, 0)),title="GridFittedBottom")
ax_vd = Axis(fig[3, 4], limits = ((-4, 4), (-1, 0)),title="Difference (GridFitted - PartialCell)")
...
#contour!(ax_vd,  yb, zb, Δv; levels, color, linewidth)
